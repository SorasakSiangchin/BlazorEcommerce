...
namespace BlazorEcommerce.Server.Controllers
{
    ...
    public class CartController : ControllerBase
    {
        ...
        [HttpPost("add")]
        public async Task<ActionResult<ServiceResponse<List<CartProductResponse>>>> AddToCart (CartItem cartItems)
        {
        ...
        public async Task<ActionResult<ServiceResponse<List<CartProductResponse>>>> UpdateQuantity (CartItem cartItems)
        {
        ...
        [HttpGet("count")]
        public async Task<ActionResult<ServiceResponse<int>>> GetCartItemsCount() => await _cartService.GetCartItemCount();
